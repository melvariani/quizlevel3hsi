...
class SoalUjianForm(ModelForm):
    ...
    kunci=forms.CharField(max_length=1,widget= forms.TextInput(attrs={'class':'form-control','placeholder':'Kunci Jawaban (A/B/C/D)'}),label="")
